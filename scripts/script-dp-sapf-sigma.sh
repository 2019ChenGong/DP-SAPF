...
for fisher_sigma in 5.0 10.0 20.0 25.0; do

    lower_name="base_top${topk}_fs${fisher_sigma}_finegrained"
    OUTPUT_DIR="../exp/lora_${subjects}_4096bs_1ksteps_eps${eps}_sigma${fisher_sigma}"
