...
OUTPUT_DIR="../exp/ldm_${subjects}_4096bs_1ksteps_eps${eps}" # Where to save the model
...
python generate_sd_bench_full.py --batch_size 30 --data_name $subjects --output_dir "/p/fzv6enresearch/gap/exp/ldm_cifar10_32_4096bs_1ksteps_eps10/full_base_0.0005" --num 60000 --target_size $sensitive_resolution --model_id $MODEL_NAME --gen_size $model_resolution