...
def main(args):
    ...
    has_step_indexed_caches = precompute_latents = args.cache_latents
    ...
    if not train_dataset.custom_instance_prompts:
        ...
        # Pre-encode all unique instance prompts once, then release the text encoder early.
        ...
        for prompt in unique_prompts:
            ...
            if isinstance(emb, (list, tuple)):
                prompt_embeds_dict[prompt] = list(emb)
            else:
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(models_to_accumulate):
                if train_dataset.custom_instance_prompts:
                    prompt_embeds = [prompt_embeds_dict[p][0] for p in batch["prompts"]]
                else:
