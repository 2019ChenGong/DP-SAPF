...
_DP_supported_layers = [nn.Embedding, 
    ...
    transformers.pytorch_utils.Conv1D, LoRACompatibleLinear
    ]
    ...
    def __init__(
        ...
        **unused_kwargs,
        ...
        for name,layer in module.named_modules():
            # print(type(layer) in _DP_supported_layers)
        ...
        for layer in module.modules():
            # print(layer, type(layer), type(layer) in _DP_supported_layers)
        ...
        for name,param in self.named_params:
            ...
            param.micro_batch_size = micro_batch_size
            param.clip_norm = 1
